...
import { ChevronRight, ChevronDown, Check, Pencil, X, CheckCircle2, AlertCircle, Info, AlertTriangle } from "lucide-react"
                              ...
                              <td className="px-3 py-2.5 text-center">
                                {isEditing ? (
                                  <input
                                    ...
                                    className="px-2 py-1.5 text-[12px] border border-[#1a5fa6] rounded w-full"
                                    autoFocus
                                  />
                                ) : (
